  ...
  return (
    <Card className="shadow-lg shadow-border p-3 sm:p-6 border-none w-full max-w-[700px] flex flex-col gap-4">
      <CardHeader className="text-center relative p-4 sm:p-6">
        ...
        <CardTitle className="text-xl sm:text-2xl font-medium mt-2">Registrar paciente</CardTitle>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value
                            ? provinces.find((state) => state.value === field.value)?.label
                    ...
                    <PopoverContent className="p-0 w-[--radix-popover-trigger-width]">
                      <Command>
                        <CommandInput placeholder="Buscar provincia" className="h-10" />
                          ...
                          <CommandGroup>
                            {provinces.map((states) => (
                              ...
                              >
                                {states.label}
                                <CheckIcon
                                  className={cn("ml-auto", states.value === field.value ? "opacity-100" : "opacity-0")}
                                />
                              </CommandItem>
                            ))}
                          </CommandGroup>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col group">
                  <FormLabel
                    ...
                    className={cn(
                      "group-focus-within:text-primary transition-colors",
                      form.formState.errors.city && "group-focus-within:text-destructive",
                    )}
                  >
                    Ciudad
                  </FormLabel>
